...
- 💳 **[Stripe ETL Pipeline](https://gitlab.com/stripe_b2)** — Automated OLTP → OLAP flow with PostgreSQL, Snowflake, and MongoDB, orchestrated via GitLab CI/CD. Handles raw Stripe data ingestion, transformation, and exploration through FastAPI + Streamlit, with seamless local & cloud deployment.
